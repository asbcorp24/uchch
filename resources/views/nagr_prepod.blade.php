        ...
        <div class="row">
            <div class="col-md-3">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body"><h3>Преподаватели</h3>
                        <br>
                        <div class="table-responsive" style="max-height: 800px">
                            <table class="table  table-hover table-bordered" style="width: 100%">
                                ...
                                @foreach($prepod as $prp)
                                    <tr>
                                        <td data-id="{{$prp->id}}" class="selgr"><a href="?pr={{$prp->id}}"
                                                                                    style="display: block; text-decoration: none;">{{$prp->fam}} {{$prp->name}} {{$prp->otch}}</a>
                                        </td>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" id="pz">
                                <h3> Нагрузка преподавателя {{$defgr!=null?$defgr->fam:''}}</h3>
...
console.log(defstr);
            ...
            $('#add').click(function () {
                $('#prepod').val({{$defgr!=null?$defgr->id:''}})
