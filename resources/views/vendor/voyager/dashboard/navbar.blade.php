<nav class="navbar navbar-default navbar-fixed-top navbar-top">
    <div class="container-fluid">
        ...
        <li class="dropdown ">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">текущий год: {{\App\God::find(\Illuminate\Support\Facades\Session::get('god',0))->nazv}}<span class="caret"></span></a>
            <ul class="dropdown-menu">

             @foreach(\App\God::all() as $gd)
                <li><a href="{{url('admin/setgod')}}?god={{$gd->id}}">{{$gd->nazv}}</a></li>
                @endforeach
