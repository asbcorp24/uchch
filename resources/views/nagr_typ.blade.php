        ...
        <div class="row">
            <div class="col-md-3">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body"><h3>Тип предмета</h3>
                        <br>
                        <div class="table-responsive" style="max-height: 800px">
                            <table class="table  table-hover table-bordered" style="width: 100%">
                                ...
                                @foreach($typpr as $tpr)
                                    <tr>
                                        <td data-id="{{$tpr->id}}" class="selgr"><a href="?pr={{$tpr->id}}"
                                                                                    style="display: block; text-decoration: none;">{{$tpr->nazv}}</a>
                                        </td>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" id="pz">
                                <h3> Специальность {{$defgr!=null?$defgr->name:''}}</h3>
...
if($(this).data('id')==1) if($(this).is(':checked'))$('.sm').show();else $('.sm').hide();
            ...
            $('#add').click(function () {
                ...
                $('#typ_pr').val(0);
                $('#zach').val(0);
                $('#typ_pr').val( {{$defgr!=null?$defgr->id:''}});
                $('#typ_pr').trigger('change');
                $('#add_n').modal('show');
