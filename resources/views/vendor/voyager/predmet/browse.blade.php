        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="voyager-trash"></i> Добавление предметов</h4>
                </div>
                <div class="modal-footer">
                    <form action="{{url('admin/add_predmet')}}" id="addb_form" method="POST">

                        {{ csrf_field() }}
                        <p> Название предметов в строчку</p>
