...
class shabon_edit extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
...
if (Session::exists('dgrp') and !isset($request->grupp))return redirect(url('admin/shablony/').'/'.Session::get('dgrp','-1'));
        ...
        $dataTypeContent =Shablon::where('grupp_id',$grupp)->get();
...
$data->grupp_id=Session::get('dgrp','-1');
$data->save();
